...
class Search {
  // Constructor craetes a new instance of the Search class
  constructor() {
    this.addSearchHTML();
  ...
  events() {
    this.openButton.click(this.openOverlay.bind(this));
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.isOverleyOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()('input, textarea').is(':focus')) {
      this.openOverlay();
    }
    if (e.keyCode == 27 && this.isOverleyOpen) {
      this.closeOverlay();
    }
  }
  addSearchHTML() {
